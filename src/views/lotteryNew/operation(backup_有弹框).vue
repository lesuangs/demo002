<template>
  <div class="operation-wrapper">
    <div class="bet-info">
      <div>
        <span>共</span><i>{{betCount}}</i>
        <span>注 共</span><i>{{updateBetMoney()}}</i>
        <span>元</span>
      </div>
      <div>
        <span>单注最多可盈利</span>
    ...
    <div class="operate-btn">
      <span class="clear-all"
            @click="clearAll()">清空</span>
      <div>
        <span>{{unitMoney}}元/注</span>
      ...
      <span class="add-list" @click="showDialog">添加注单</span>
    </div>
    <!--弹框-->
    <div class="add-list-wrapper" v-show="isShow">
      <div class="rebate-wrapper">
        ...
        <div class="btn-wrapper">
          <span @click="showDialog">{{$t('lang.lottery.bottom.queue.btn[0]')}}</span>
