    ...
    <slot name="pulldown"
      ...
      <div ref="pulldown"
        ...
        <div class="before-trigger"
             v-if="beforePullDown">
             <span class="trigger-text">{{$t('lang.BScroll.shiFangShuaXin')}}</span>
        </div>
...
export default {
  ...
  computed: {
    pullUpTxt () {
      const moreTxt = (this.pullUpLoad && this.pullUpLoad.txt && this.pullUpLoad.txt.more) || this.$t('lang.BScroll.jiaZaiGengDuo')
      const noMoreTxt = (this.pullUpLoad && this.pullUpLoad.txt && this.pullUpLoad.txt.noMore) || this.$t('lang.BScroll.meiYouGengDuo')
      return this.pullUpDirty ? moreTxt : noMoreTxt
    },
    refreshTxt () {
      return (this.pullDownRefresh && this.pullDownRefresh.txt) || this.$t('lang.common.refreshSuccessfully')
    }
  },
  created () {
